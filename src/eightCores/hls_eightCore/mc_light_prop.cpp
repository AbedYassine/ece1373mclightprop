...
#pragma HLS INTERFACE m_axi depth=8192 port=material_index name=material_index_bram
#pragma HLS INTERFACE bram port=absorption name=absorption_bram
#pragma HLS INTERFACE m_axi depth=128 port=materials_array name=materials_array
#pragma HLS DATAFLOW
...
#pragma HLS ARRAY_PARTITION variable=material_index cyclic factor=4 dim=1
#pragma HLS ARRAY_PARTITION variable=absorption cyclic factor=4 dim=1
